...
public class p09_DividirEnCifras {
    public static void main(String[] args) { 
        ...
        System.out.println("Dame un numero entero de 3 cifras: "); num = new Scanner(System.in).nextInt(); 
        centenas = num / 100 ; 
        decenas = ( num - centenas * 100) / 10 ; 
        unidades = ( num - (centenas * 100 + decenas * 10) ); 
        System.out.println("El nuemero introducido fue : " + num); System.out.println("Centenas : " + centenas); 
