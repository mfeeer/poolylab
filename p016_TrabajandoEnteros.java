/**
 * p016_TrabajandoEnteros - Trabajando con variables y literales enteras
 */
...
public class p016_TrabajandoEnteros {
    public static void main(String[]args){
        ...
        long ganancia = 9223372036854733307L; //agregar una L AL FINAL PARA GUAFRDAR EL DATO TIPO LONG
        ...
        System.out.println("num2 base decimal. : " + Integer.toString(num2)); //integer.tostring sirve para formateo de datos
